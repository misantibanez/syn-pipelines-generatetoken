...
$tenantId = "<tenant_id>"; #the tenant ID in which the Data Collection Endpoint resides
$appId = "<app_id>"; #the app ID created and granted permissions
$appSecret = "<app_secret>"; #the secret created for the above app - never store your secrets in the source code
##### >>>> END <<<<<
